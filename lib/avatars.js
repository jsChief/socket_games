...
const PATTERNS = ["random", "checker", "stripes", "rings", "dots", "cross", "face"];

// Named monochrome colors accepted alongside hue degrees.
const MONO_COLORS = ["black", "white"];
...
function setAvatarSettings(uid, opts) {
  ...
  if (opts && opts.color !== undefined && opts.color !== null) entry.color = opts.color;
