Vue.component("pizza-view", {
      ...
      template: `
            <div class="mx-auto w-full max-w-3xl space-y-3 px-3 py-4">
                  <!-- Header -->
                  <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-amber-400 to-red-500 px-4 py-3 text-white shadow-[0_8px_0_rgba(0,0,0,0.18)]">
                        ...
                        <div class="relative z-10 flex items-center gap-3">
                              ...
                              <div class="min-w-0 flex-1 leading-tight">
                                    <h1 class="min-w-0 flex-1 truncate text-lg sm:text-xl font-black leading-none">Find My Pizza</h1>
                                    <div class="md:flex items-center gap-2 mt-2 place-content-between">
                                          <p class="hidden md:block mt-0.5 truncate text-xs font-bold text-white/85">Hide 5 slices, then hunt your opponent's!</p>
